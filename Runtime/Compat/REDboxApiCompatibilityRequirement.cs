...
#error [REDbox] This package requires the .NET Framework 4.x API Compatibility Level. Fix: Edit > Project Settings > Player > Other Settings > Api Compatibility Level > select ".NET Framework". Then re-open the project or reimport the package.
#endif
